...
const neoClasses =
  "w-full rounded-full px-3.5 py-5 border-2 relative z-10 text-10 font-bold hover:transform hover:translate-y-[-2px] transition-transform-duration-200";
...
export const spanVariants = cva(
  ["absolute", "h-14", "bottom-[-7px]", "w-full", "border-2", "left-0"],
  {
    variants: {
      variant: {
        default: "hidden",
